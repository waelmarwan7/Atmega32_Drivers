...
void  DIO_SetPortDirection (u8 U8PortIdcopy ,u8 U8PinDirCopy)
{
	if(U8PortIdcopy<=DIO_PORTD)
	{
			...
			switch (U8PortIdcopy)
			{
			case DIO_PORTA : SET_PORT(DDRA,U8PinDirCopy); break;
			case DIO_PORTB : SET_PORT(DDRB,U8PinDirCopy); break;
			case DIO_PORTC : SET_PORT(DDRC,U8PinDirCopy); break;
			case DIO_PORTD : SET_PORT(DDRD,U8PinDirCopy); break;
			}
